<template>
  <div
    v-if="!isSmallScreen && !hasCardActive"
    data-cursor-hover
  ...
  >
    ...
    <div class="pb-7 px-8 text-offwhite-100 !font-medium !tracking-wide leading-[1.2] transition group-hover:text-primary-500">
  ...
  >
    ...
    <div
      ...
      <div class="ml-auto hidden lg:block scale-75 xl:scale-125 xl:pr-32 xl:pl-20">
        <slot name="animation">
          <!-- Animação -->
        </slot>
      </div>
